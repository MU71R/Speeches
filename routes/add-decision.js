...
const { addDecision, getalldecisions, deleteDecision, getDecisionById, updateDecision } = require("../controller/add-decision");
...
router.put("/update-decision/:id", verifyTokenMiddleware, updateDecision);
